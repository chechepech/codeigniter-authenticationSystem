  ...
  <h1><?php echo $page_heading ; ?></h1>
	...
	<div class="span8"> 
	    ...
	    <div class="form-group">
	      ...
	      <input type="radio" name="usr_is_active" value="1" <?php echo $usr_is_active == 1 ? 'checked':'';?> /> Active
	      <input type="radio" name="usr_is_active" value="0" <?php echo $usr_is_active == 0 ? 'checked':'';?> /> Inactive
	    </div>
		<!--buttons-->
	    <?php echo form_hidden($id); ?>		
	    <div class="form-group">
	      <button type="submit" class="btn btn-default"><?php echo $this->lang->line('common_form_elements_go');?></button> or <?php echo anchor('users',$this->lang->line('common_form_elements_cancel'));?>
	    </div>
		<?php echo form_close(); ?>
	</div>
