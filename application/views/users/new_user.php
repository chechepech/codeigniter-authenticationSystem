...
<?php echo form_open('users/new_user','role="form" class="form"') ; ?>
    ...
    <div class="form-group">
      ...
      <input type="radio" name="usr_is_active" value="<?php echo set_value('usr_is_active','1'); ?>" /> Active
      <input type="radio" name="usr_is_active" value="<?php echo set_value('usr_is_active','0'); ?>" /> Inactive
     </div>      
